...
const Cancer_Hero_Section = () => {
    ...
    return (
        <>
            <div>
                <section className='h-fit w-[450px] text-green-500 mt-6 ml-4 rounded lg:mt-0 lg:w-[1100px] '>
                                    ...
                                    <>
                                        {
                                            names.toLowerCase() == query_cancer.toLowerCase() || title.toLowerCase() == query_cancer.toLowerCase() ?
                                                ...
                                                <Link>
                                                    <section key={id} className="mt-4 p-2 lg:mb-0 rounded-t-2xl  mb-2 border  cursor-pointer lg:h-[470px] lg:w-[360px] lg:ml-24 bg-gradient-to-r from-green-500 to-green-300 via-green-200 hover:from-green-500 hover:to-green-700  rounded-2xl">
